...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    setError(null); // ИСПРАВЛЕНО: Очищаем ошибку при инициализации компонента
      ...
      // ИСПРАВЛЕНО: Проверяем план перед загрузкой рекомендаций, чтобы не вызывать /api/recommendations для новых пользователей
      ...
      // План есть - загружаем рекомендации (initData передается автоматически в запросе)
