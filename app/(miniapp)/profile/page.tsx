            ...
            {skinProfile && (
              <>
                <div style={{
                  ...
                  <span style={{ color: '#475467' }}>Тип кожи</span>
                  <span style={{ color: '#0A5F59', fontWeight: '600' }}>
                    {skinProfile.skinType || 'Не определен'}
                  </span>
                </div>
                <div style={{
                  display: 'flex',
                  ...
                  <span style={{ color: '#475467' }}>Чувствительность</span>
                  <span style={{ color: '#0A5F59', fontWeight: '600' }}>
                    {skinProfile.sensitivityLevel || 'Не определена'}
                  </span>
                </div>
                <div style={{
                  display: 'flex',
                  ...
                  <span style={{ color: '#475467' }}>Уровень акне</span>
                  <span style={{ color: '#0A5F59', fontWeight: '600' }}>
                    {skinProfile.acneLevel || 'Не определен'}
                  </span>
                </div>
              </>
            )}
            ...
            {!skinProfile && (
              <div style={{
                ...
                <p style={{ color: '#475467', marginBottom: '12px' }}>
                  Пройдите анкету, чтобы получить персональный анализ кожи
                </p>
                <button
                  onClick={() => router.push('/quiz')}
                  style={{
