...
export const INFO_SCREENS: InfoScreen[] = [
  ...
  // ai_comparison), заменён на sunk-cost framing — «вы уже почти всё сделали».
  {
    ...
    subtitle: 'На основе ваших ответов формируем персональный протокол ухода под тип кожи, цели и бюджет.\n\nДо персонального плана ухода осталось несколько секунд.',
