...
export const INFO_SCREENS: InfoScreen[] = [
  ...
  // 2) Как это работает?
  {
    ...
    subtitle: '1. Ответьте на несколько вопросов\n\n2. Получите персональную подборку ухода\n\n3. Посмотрите как будет выглядеть кожа уже через 12 недель применения средств',
    ctaText: 'Продолжить',
  },
  ...
  // 3) SkinIQ — ваш персональный анализ кожи
  {
    ...
    subtitle: 'Ваш полный анализ включает:\n\n🔍 Детальный разбор — морщины, линии и текстура в 3D\n💧 Уровень увлажнённости — персональная оценка баланса влаги\n🔬 Поры — точное выявление и измерение\n💚 Здоровье кожи — покраснения, воспаления, раздражения\n\nФакты:\n✅ 92% пользователей отмечают улучшение состояния кожи за 1 месяц\n✅ SkinIQ в 3 раза эффективнее обычных рутин',
    ctaText: 'Продолжить',
  },
  
  // 4) Расскажите нам о вашей цели
  {
    id: 'goals_intro',
  ...
  // 6) Отзывы с горизонтальным скроллом
  {
    ...
    content: [
      {
        stars: 5,
        text: 'С помощью подобранного ухода я убрала акне и следы постакне за 3 месяца. Удобно, что рекомендации персонализированы!',
        author: 'Ольга, Санкт-Петербург',
      },
      {
        stars: 5,
        text: 'Моя кожа стала более упругой и увлажнённой. Приложение помогло подобрать уход, который реально работает!',
        author: 'Дарья, Казань',
      },
      {
        stars: 5,
        text: 'У меня была проблема с покраснением и чувствительностью, через месяц стало намного лучше, кожа спокойнее!',
        author: 'Ирина, Новосибирск',
      },
      {
        stars: 5,
        text: 'Всегда мучалась с расширенными порами и жирным блеском. Теперь макияж хорошо держится, жирный блеск появляется только к концу дня',
        author: 'Екатерина, Москва',
      },
    ],
    ctaText: 'Продолжить',
  },
