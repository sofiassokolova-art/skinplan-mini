...
export const INFO_SCREENS: InfoScreen[] = [
  ...
  // 2) Как это работает?
  {
    ...
    subtitle: '1. Ответьте на несколько вопросов\n\n2. Загрузите фото\n\n3. Получите персональную подборку ухода\n\n4. Посмотрите как будет выглядеть кожа уже через 12 недель применения средств',
    ctaText: 'Продолжить',
  },
  ...
  // 6) Отзывы с горизонтальным скроллом
  {
    ...
    content: [
      {
        stars: 5,
        text: 'С помощью подобранного ухода я убрала акне и следы постакне за 3 месяца. Удобно, что можно просто загрузить фото!',
