      ...
      <div className="animate-fade-in">
        ...
        {!hideProgressBar && (
          <div style={{
            ...
            // Для skin_goals и skin_type: внешний padding 0px, поэтому используем calc для центрирования с отступами 20px от края
            // calc(50% - 300px) центрирует прогресс-бар шириной 600px, max(20px, ...) обеспечивает минимальный отступ 20px
            // Это создает такое же положение прогресс-бара, как на экране "Возраст"
            width: '100%',
            maxWidth: '600px',
