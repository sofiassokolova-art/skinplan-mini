...
export function QuizInfoScreen({
  ...
  // Экран "Общая информация", "Узнаем особенности вашей кожи" и "Данные о здоровье" - абсолютное позиционирование
  if (isGeneralInfoIntroScreen || isSkinFeaturesIntroScreen || isHealthDataScreen) {
    // Кнопка "Назад" через портал для гарантированной фиксации
