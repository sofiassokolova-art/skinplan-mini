...
export default function QuizPage() {
  ...
  const submitAnswers = async () => {
    ...
    try {
      ...
      // Очищаем прогресс перед редиректом
      clearProgress();
      ...
      if (typeof window !== 'undefined') {
        // Используем replace вместо href, чтобы избежать возможности вернуться назад
        // и предотвратить обновления состояния после редиректа
