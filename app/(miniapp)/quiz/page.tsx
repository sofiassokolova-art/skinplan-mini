...
export default function QuizPage() {
  ...
  // КРИТИЧНО: Проверяем sessionStorage синхронно при каждом рендере, чтобы гарантировать актуальность
  ...
  // КРИТИЧНО: Если isSubmitting=true ИЛИ justSubmittedUiGuard=true, то НЕ показываем лоадер анкеты
  const isRedirectingToPlan = isSubmitting || justSubmittedUiGuard;
  
  // ДОПОЛНИТЕЛЬНАЯ ЗАЩИТА: Если isRedirectingToPlan=true, то loading должен быть проигнорирован
  // Это предотвращает мигание лоадера анкеты даже на один кадр
