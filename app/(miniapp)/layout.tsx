...
function LayoutContent({
  ...
  // Скрываем навигацию на главной странице до завершения проверки плана
  useEffect(() => {
    // Скрываем навигацию на главной странице до завершения проверки плана (до 2 секунд)
    ...
    if (pathname === '/') {
      ...
      setTimeout(() => setIsCheckingProfile(false), 2000);
    } else {
